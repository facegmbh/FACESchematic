...
- **The imported PDF is kept** — in the browser's own storage, so switching pages, changing the PDF's layers or its resolution still redraws the plan after a reload instead of asking for the file again
