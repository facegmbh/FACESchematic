...
- **Covers turn and fade** — the white patches over the architect's own title block can be rotated to match it and faded to quiet linework instead of erasing it
