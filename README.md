...
- **Plan resolution in dpi** — an imported PDF is rasterized at a resolution of the real sheet (150 dpi by default, 100 to 300 selectable), instead of a fixed pixel count that left large A1 drawings at 72 dpi
