    ...
    <>
      ...
      <table>
        ...
        <tbody>
          ...
          <tr><td><code>planSymbol</code></td><td>object</td><td>How the model is drawn on a <a href="/floorplans">floorplan</a>: <code>{"{ shape, color?, glyph? }"}</code> with shape <code>circle</code> / <code>square</code> / <code>triangle</code> / <code>diamond</code>, a <code>#rrggbb</code> color and up to two characters printed inside the symbol. Without it, the shape follows the device type (speakers round, subs square, microphones triangles, video diamonds) and the color is derived from the id</td></tr>
