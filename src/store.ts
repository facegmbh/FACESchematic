...
interface SchematicState {
  ...
  updateFloorplanPage: (pageId: string, patch: Partial<Pick<FloorplanPage, "showTitleBlock" | "symbolSizeMm" | "labelSizeMm" | "labelTemplate" | "kind" | "hideCoverages">>) => void;
...
export const useSchematicStore = create<SchematicState>((set, get) => ({
  ...
  useShortNames: false,
  // Default on, matching newSchematic(). Devices leaving data.wrapLabel undefined inherit this.
  ...
  saveToLocalStorage: () => {
    ...
    const data: SchematicFile = {
      ...
      wrapDeviceLabels: state.wrapDeviceLabels === false ? false : undefined,
  ...
  loadFromLocalStorage: () => {
    try {
      ...
      companyProfile: data.companyProfile ?? loadCompanyProfile(),
            ...
            wrapDeviceLabels: data.wrapDeviceLabels ?? true,
